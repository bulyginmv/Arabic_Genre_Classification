...
#opening and spliting training corpus
...
#preprocessing of the training and test corpora
...
#the actual training and predicting
for i in range (18):
...
#Saving predictions in the txt file
